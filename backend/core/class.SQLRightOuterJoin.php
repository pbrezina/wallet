<?php declare(strict_types=1);
    ...
    /**
     * SQL Right Outer Join operator.
     */
    class SQLRightOuterJoin extends SQLJoin
    {
        /**
         * Create '$left RIGHT OUTER JOIN $right' SQL join.
         *
        ...
        {
            parent::__construct($flavor, $left, 'RIGHT OUTER JOIN', $right);
        }
    }
?>
