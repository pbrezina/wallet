<?php declare(strict_types=1);
    ...
    final class SQLLeftOuterJoinTest extends TestCase
    {
        private $flavor;
        ...
        {
            $obj = new SQLLeftOuterJoin($this->flavor, 'left', 'right');
            $this->assertEquals(
        ...
        public function testGet_bothTableWithCondition() : void
        {
            ...
            $this->assertEquals(
                '`left` LEFT OUTER JOIN `right` ON `left`.`id` = `right`.`id`',
                $obj->get()
            );
        }
        ...
        {
            $obj = new SQLLeftOuterJoin(
                $this->flavor,
                ['l' => 'left'],
                ['r' => 'right']);
            $this->assertEquals(
                '`left` AS `l` LEFT OUTER JOIN `right` AS `r`',
                $obj->get()
            );
        }
        ...
        public function testGet_leftQueryNoCondition() : void
        {
            ...
            $obj = new SQLLeftOuterJoin(
                ...
                ['r' => 'right']);
            $this->assertEquals(
                '(SELECT * FROM `left`) AS `l` LEFT OUTER JOIN `right` AS `r`',
                $obj->get()
            );
        }
        ...
        public function testGet_rightQueryNoCondition() : void
        {
            ...
            $obj = new SQLLeftOuterJoin(
                ...
                ['r' => $select]);
            $this->assertEquals(
                '`left` AS `l` LEFT OUTER JOIN (SELECT * FROM `right`) AS `r`',
                $obj->get()
            );
        }
        ...
        public function testGet_bothQueryNoCondition() : void
        {
            ...
            $obj = new SQLLeftOuterJoin(
                ...
                ['r' => $right]);
            $this->assertEquals(
                '(SELECT * FROM `left`) AS `l` LEFT OUTER JOIN (SELECT * FROM `right`) AS `r`',
                $obj->get()
            );
        }
        ...
        public function testGet_bothQueryWithCondition() : void
        {
            ...
            $obj = new SQLLeftOuterJoin(
                ...
                $obj->on('::l.id = ::r.id');
            $this->assertEquals(
                '(SELECT * FROM `left`) AS `l` LEFT OUTER JOIN (SELECT * FROM `right`) AS `r` ON `l`.`id` = `r`.`id`',
                $obj->get()
            );
        }
    }
